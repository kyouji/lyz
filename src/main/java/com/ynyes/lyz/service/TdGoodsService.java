...
//    private TdUserCollectService tdUserCollectService;
    ...
    public Boolean  getrecommend(ModelMap map){
    	...
    	// 分类推荐
    	map.addAttribute("type_recommend_page", this.findByIsRecommendTypeTrueAndIsOnSaleTrueOrderByIdDesc(0, SiteMagConstant.pageSize));
        
        // 销量排行
    	map.addAttribute("soldNumber_recommend_page", this.findByIsOnSaleTrueOrderBySoldNumberDesc(0, SiteMagConstant.pageSize));
        
        // 新品推荐
    	map.addAttribute("new_recommend_page", this.findByIsNewTrueAndIsOnSaleTrueOrderByIdDesc(0, SiteMagConstant.pageSize));
        
        // 首页推荐商品      
    	map.addAttribute("index_recommend_page", this.findByIsRecommendIndexTrueAndIsOnSaleTrueOrderByIdDesc(0, SiteMagConstant.pageSize));
        
        // 特价推荐商品
    	map.addAttribute("specialPrice_recommend_page", this.findByIsSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(0, SiteMagConstant.pageSize));
     
    	// 热卖推荐
    	map.addAttribute("hot_recommend_page", this.findByIsHotTrueAndIsOnSaleTrueOrderByIdDesc(0, SiteMagConstant.pageSize));
    ...
    public Boolean getrecommendByCategory(Long catId, ModelMap map){
    	...
    	// 特定类型的分类推荐
    	map.addAttribute("type_recommend_page", this.findByCategoryIdAndIsRecommendTypeTrueAndIsOnSaleTrueOrderByIdDesc(catId, 0, SiteMagConstant.pageSize));
        
        // 特定类型的销量排行
    	map.addAttribute("soldNumber_recommend_page", this.findByCategoryIdAndIsOnSaleTrueOrderBySoldNumberDesc(catId, 0, SiteMagConstant.pageSize));
        
        // 特定类型的新品推荐
    	map.addAttribute("new_recommend_page", this.findByCategoryIdAndisNewTrueAndIsOnSaleTrueOrderByIdDesc(catId, 0, SiteMagConstant.pageSize));
        
        // 特定类型的首页推荐商品      
    	map.addAttribute("index_recommend_page", this.findByCategoryIdAndIsRecommendIndexTrueAndIsOnSaleTrueOrderByIdDesc(catId, 0, SiteMagConstant.pageSize));
        
        // 制定类别的特价推荐商品
    	map.addAttribute("specialPrice_recommend_page", this.findByCategoryIdAndisSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(catId, 0, SiteMagConstant.pageSize));
     
    	// 特定类型的热卖推荐
    	map.addAttribute("hot_recommend_page", this.findByCategoryIdAndisHotTrueAndIsOnSaleTrueOrderByIdDesc(catId, 0, SiteMagConstant.pageSize));
    ...
    /**
	 * @author lc
	 * @注释：特定类型的商品推荐(包含热卖、新品、首页推荐、分类推荐、特价)
	 */
    // 特定类型的分类推荐
    ...
    //特定类型的新品推荐商品
    public Page<TdGoods> findByCategoryIdAndisNewTrueAndIsOnSaleTrueOrderByIdDesc(
            Long catId, int page, int size) {
        if (null == catId) {
            return null;
        }
        ...
        return repository
                .findByCategoryIdTreeContainingAndIsNewTrueAndIsOnSaleTrueOrderByIdDesc(
                        catStr, pageRequest);
    } 
    
    //特定类型的特价推荐商品
    public Page<TdGoods> findByCategoryIdAndisSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(
            Long catId, int page, int size) {
        if (null == catId) {
            return null;
        }
        ...
        return repository
                .findByCategoryIdTreeContainingAndIsSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(
                        catStr, pageRequest);
    } 
    
    //特定类型的热卖推荐商品
    public Page<TdGoods> findByCategoryIdAndisHotTrueAndIsOnSaleTrueOrderByIdDesc(
            Long catId, int page, int size) {
        if (null == catId) {
            return null;
        }
        ...
        return repository
                .findByCategoryIdTreeContainingAndIsHotTrueAndIsOnSaleTrueOrderByIdDesc(
                        catStr, pageRequest);
    } 
    
    /**
	 * @author lc
	 * @注释：商品推荐(包含热卖、新品、首页推荐、分类推荐、特价)
	 */
    //查找分类推荐上架商品按id排序
    ...
    //查找特价推荐上架商品按id排序
    public Page<TdGoods> findByIsSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(
            int page, int size) {
        PageRequest pageRequest = new PageRequest(page, size);

        return repository
                .findByIsSpecialPriceTrueAndIsOnSaleTrueOrderByIdDesc(pageRequest);
    }
    
    //查找特价推荐上架商品按id排序
    public Page<TdGoods> findByIsHotTrueAndIsOnSaleTrueOrderByIdDesc(
            int page, int size) {
        PageRequest pageRequest = new PageRequest(page, size);

        return repository
                .findByIsHotTrueAndIsOnSaleTrueOrderByIdDesc(pageRequest);
    }
