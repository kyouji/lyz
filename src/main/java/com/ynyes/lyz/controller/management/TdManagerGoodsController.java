...
public class TdManagerGoodsController {
	...
	public String goodsListPost(Integer page, Integer size, Long categoryId, String property, String saleType,
		...
		// else
		// {
		// goodsPage = tdGoodsService.searchAndOrderBySortIdAsc(keywords, page,
		// size);
		// }
		// }
		// else
		...
		// if (null == keywords || "".equalsIgnoreCase(keywords))
		// {
		// goodsPage = tdGoodsService.findByIsOnSaleTrueOrderBySortIdAsc(page,
		// size);
		// }
		// else
		// {
		// goodsPage =
		// tdGoodsService.searchAndIsOnSaleTrueOrderBySortIdAsc(keywords, page,
		// size);
		// }
		// }
		// }
		...
		// {
		// goodsPage =
		// tdGoodsService.findByCategoryIdTreeContainingOrderBySortIdAsc(categoryId,
		// page, size);
		// }
		// else
		// {
		// goodsPage =
		// tdGoodsService.searchAndFindByCategoryIdOrderBySortIdAsc(keywords,
		...
		// {
		// goodsPage =
		// tdGoodsService.findByCategoryIdTreeContainingAndIsOnSaleTrueOrderBySortIdAsc(categoryId,
		// page, size);
		// }
		// else
		// {
		// goodsPage =
		// tdGoodsService.searchAndFindByCategoryIdAndIsOnSaleTrueOrderBySortIdAsc(keywords,
		// categoryId, page, size);
		// }
		// }
		// }
